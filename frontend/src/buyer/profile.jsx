    ...
    try {
      ...
      if (data.message == true) {
        setBuyerDetails({
          ...
          email: data.email,
          totalGigsBuyed: data.totalGigsBuyed,
          totalAmountSpend: 0, //data.AmountSpend,
        });
          ...
          <>
            ...
            <Row className="mt-5 justify-content-center">
              ...
              >
                ...
                >
                  <Card.Body>
                    <Card.Title>Total Gigs Purchased</Card.Title>
                    <Card.Text
                      style={{
                        fontSize: "34px",
                        fontWeight: "bold",
